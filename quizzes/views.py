...
def home_page(request):
    ...
    context = {
            ...
            'quizzes': quizzes,
            'latest_quiz': latest_quiz.title if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available" if latest_quiz else "No quizzes available",
        }
